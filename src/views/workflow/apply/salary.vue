<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <salary-form :operate="operate" :businessKey="row.id" @close="closeForm"></salary-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <salary-detail :operate="operate" :businessKey="row.id" @close="closeForm"></salary-detail>
        </el-dialog>
    </div>
</template>
...
import SalaryForm from '@/components/Process/Form/SalaryForm'
...
export default {
    ...
    methods: {
        ...
        window.open('http://localhost:9528/smsaIr/download/'+row.id)
        },
