<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <audit-form :operate="operate" :businessKey="row.id" @close="closeForm"></audit-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <audit-detail :operate="operate" :businessKey="row.id" @close="closeForm"></audit-detail>
        </el-dialog>
    </div>
</template>
...
import AuditForm from '@/components/Process/Form/AuditForm'
...
export default {
    ...
    methods: {
        ...
        window.open('http://localhost:9528/aacp/download/'+row.id)
        },
