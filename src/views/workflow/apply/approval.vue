<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <approval-form :operate="operate" :businessKey="row.id" @close="closeForm"></approval-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <approval-detail :operate="operate" :businessKey="row.id" @close="closeForm"></approval-detail>
        </el-dialog>
    </div>
</template>
...
import ApprovalForm from '@/components/Process/Form/ApprovalForm'
...
export default {
    ...
    methods: {
        ...
        window.open('http://localhost:9528/cpm/download/'+row.id)
        },
