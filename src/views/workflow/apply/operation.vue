<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <operation-form :operate="operate" :businessKey="row.id" @close="closeForm"></operation-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <operation-detail :operate="operate" :businessKey="row.id" @close="closeForm"></operation-detail>
        </el-dialog>
    </div>
</template>
...
import OperationForm from '@/components/Process/Form/OperationForm'
...
export default {
    ...
    methods: {
        ...
        window.open('http://localhost:9528/dpp/download/'+row.id)
        },
