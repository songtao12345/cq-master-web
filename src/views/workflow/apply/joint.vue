<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <joint-form :operate="operate" :businessKey="row.id" @close="closeForm"></joint-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <joint-detail :operate="operate" :businessKey="row.id" @close="closeForm"></joint-detail>
        </el-dialog>
    </div>
</template>

<script>
import api from '@/api/joint'
...
import JointForm from '@/components/Process/Form/JointForm'
