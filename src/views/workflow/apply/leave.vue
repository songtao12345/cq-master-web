            ...
            <el-table-column  align="center" label="操作" fixed="right" width="220">
                <template slot-scope="{row}">
                    ...
                    <el-button v-if="row.status == 0" @click="clickSubmit(row)" type="text" >重新申请</el-button>
                      ...
                      <!-- <el-popconfirm :title="`您确定部署【${row.name}】吗？`" @onConfirm="clickSubmitApply(row.id)" style="margin: 0 5px" >
                        <el-button slot="reference" type="text" size="small">重新申请</el-button>
                    </el-popconfirm> -->
        ...
        clickSubmit(row) {
            ...
            type: 'warning'
                ...
                const data = {
                    ...
                    // console.log(res);
                     if(res.code !== 200) return this.$message.error('申请失败')
