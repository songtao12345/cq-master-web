<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <safety-form :operate="operate" :businessKey="row.id" @close="closeForm"></safety-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <safety-detail :operate="operate" :businessKey="row.id" @close="closeForm"></safety-detail>
        </el-dialog>
    </div>
</template>
...
import SafetyForm from '@/components/Process/Form/SafetyForm'
...
export default {
    ...
    methods: {
        ...
        window.open('http://localhost:9528/uospf/download/'+row.id)
        },
