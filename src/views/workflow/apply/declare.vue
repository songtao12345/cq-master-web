<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <declare-form :operate="operate" :businessKey="row.id" @close="closeForm"></declare-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <declare-detail :operate="operate" :businessKey="row.id" @close="closeForm"></declare-detail>
        </el-dialog>
    </div>
</template>

<script>
import api from '@/api/declare'
...
import DeclareForm from '@/components/Process/Form/DeclareForm'
...
export default {
    ...
    methods: {
        ...
        window.open('http://localhost:9528/paaac/download/'+row.id)
        },
