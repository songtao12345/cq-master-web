<template>
     <div class="app-container">
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="formVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <bid-form :operate="operate" :businessKey="row.id" @close="closeForm"></bid-form>
        </el-dialog>
        <!-- 撤回申请 -->
        ...
        <el-dialog v-dialogDrag :title="operate" :visible.sync="detailFormVisible" @close="closeForm(false)" width="1000px" destroy-on-close>
            <bid-detail :operate="operate" :businessKey="row.id" @close="closeForm"></bid-detail>
        </el-dialog>
    </div>
</template>
...
import BidForm from '@/components/Process/Form/BidForm'
...
export default {
    ...
    methods: {
        ...
        window.open('http://localhost:9528/pb/download/'+row.id)
        },
