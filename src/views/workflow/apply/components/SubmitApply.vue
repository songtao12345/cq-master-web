<template>
    <el-dialog v-dialogDrag title="提交申请" :visible.sync="visible" width="500px" destroy-on-close>
        <el-form v-loading="loading" :rules="rules" ref="formData" :model="formData"  size="mini"  status-icon>
            <el-form-item label="请输入审批人用户名" prop="assignees" label-width="150px">
                ...
                <!-- <el-select v-model="formData.assignees" multiple placeholder="请选择用户" ref="selected">
                    <el-option
            ...
            <el-form-item align="center">
                ...
                <el-button size="mini" @click="clickClose">取消</el-button>
            </el-form-item>
        </el-form>
    </el-dialog>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                assignees: [
                    {required: false, message: '请输入审批人用户名', trigger: 'blur'},
                ]
            }
        }
    },
